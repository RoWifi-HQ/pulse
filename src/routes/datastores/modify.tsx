...
import { type TauriError, ErrorKind } from "../../types";
...
export function DeleteModal({
  ...
  return (
    <Dialog.Root open={isOpen} onOpenChange={setOpen}>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="fixed top-0 left-0 w-screen h-screen bg-black/50 flex items-center justify-center z-50" />
        <Dialog.Content className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-(--breakpoint-lg) max-h-[75%] overflow-y-auto scrollbar bg-neutral-800 outline-hidden p-8 rounded-md z-50">
          <div className="outline-hidden flex flex-col items-center">
